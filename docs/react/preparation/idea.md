...
<img :src="$withBase('/assets/react/long-task.png')" alt="长任务">
...
<img :src="$withBase('/assets/react/time-slice.png')" alt="时间分片">
...
<img :src="$withBase('/assets/react/legacy-move.gif')" alt="同步">

作为对比，再点击“设置”面板中的“Siri与搜索”，进入“Siri与搜索”界面：

<!-- <img  :src="$withBase('/img/concurrent-mov.gif')" alt="异步"> -->

<img :src="$withBase('/assets/react/concurrent-mov.gif')" alt="异步">
